...
<div class="container">
	...
	<div class="container">
		<div class="row">
			<fieldset class="cont text-center" id="recurrencia">

				<legend class="text-title-recurrence">Frecuencia de pago</legend>

				<div class="wrap-tarjetas">
					<p class="text-center">Tarjetas vinculadas</p>
				...
				<form class="fiedset-wrapper">
					...
					<div class="row cont-form">
						...
						<div class="form-group form-item form-fecha-tc">
							...
							<div class="clearfix"></div>
							<input class="form-control-n m-der" type="datetime" maxlength="2" id="mm" name="mm" placeholder="mm" pattern="[0-9]{2}">
							<input class="form-control-n" type="num" maxlength="4" id="aaaa" name="aaaa"  placeholder="aaaa" pattern="[0-9]{4}">
							<div class="clearfix"></div>
						</div>
					</div>
